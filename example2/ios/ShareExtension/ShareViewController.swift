...
class ShareViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let myGroupID = "group.org.humaidk2.example.example2"; // the group dir that can be accessed by App & extensions
...
//      url.setResourceValue(numberwithboo, forKey: <#T##Foundation.URLResourceKey#>)
      ...
      let mmkv = MMKV(mmapID: "storage", mode: MMKVMode.multiProcess)
